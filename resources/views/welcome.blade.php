...
<head>
    ...
    <link rel="stylesheet" href="C:\Users\fitri\Desktop\laravel nik\cctv-dashboard\resources\views\main.css"> <!-- Link to your new CSS file -->
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="homepage.php">CCTV Cameras</a>
                </li>
            </ul>
        </div>
    </nav>
